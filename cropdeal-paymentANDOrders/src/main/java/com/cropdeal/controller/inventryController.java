...
public class inventryController {
	...
	public ResponseEntity<HttpStatus> deleteproduct(@PathVariable Integer id) throws noProductFoundException {
	...
	public product getProductById(@PathVariable Integer id) throws noProductFoundException {
...
//		int formerId = requestUserId();
	...
	public ResponseEntity<HttpStatus> removeFromCart(@PathVariable Integer productId) throws noProductFoundException{
